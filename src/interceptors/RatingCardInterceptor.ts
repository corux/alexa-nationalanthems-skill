...
export class RatingCardInterceptor implements ResponseInterceptor {
  public async process(handlerInput: IExtendedHandlerInput, response?: Response): Promise<void> {
    ...
    if (showRatingCard) {
      ...
      response.card = {
        image: {
          smallImageUrl: "https://i35kgypfrd.execute-api.eu-west-1.amazonaws.com/production/https://s3-eu-west-1.amazonaws.com/alexa-nationalanthems-skill/icon512.png",
        },
