    ...
    if (!currentAudio) {
      ...
      return handlerInput
        ...
        .if(isLoopOnIntent, (builder) =>
          builder.speak(`${t("audio.loop-on-prepare")} ${t("help.reprompt")}`)
        )
        .if(!isLoopOnIntent, (builder) =>
          builder.speak(`${t("audio.loop-off")} ${t("help.reprompt")}`)
        )
    ...
    return handlerInput
      ...
      .if(isLoopOnIntent, (builder) =>
        builder.speak(
          t(
            "audio.loop-on",
            getTArgument(currentAudio.country, handlerInput.getLocale())
          )
        )
      )
      ...
      .addAudioPlayerPlayDirective(
        ...
        createAudioToken(currentAudio.country, isLoopOnIntent),
        offset,
        undefined,
