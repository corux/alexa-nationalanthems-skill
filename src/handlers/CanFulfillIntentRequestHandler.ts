import { BaseRequestHandler, IExtendedHandlerInput, Locale, Request } from "@corux/ask-extensions";
...
export class CanFulfillIntentRequestHandler extends BaseRequestHandler {
  ...
  private canFulfill(handlerInput: IExtendedHandlerInput): canfulfill.CanFulfillIntent {
